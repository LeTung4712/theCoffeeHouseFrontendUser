                                ...
                                <ul class="tch-list-payment-method mb-0 fix_position">
                                    <li class="tch-payment-method-item">
                                        <div class="custom-control custom-radio mb-0">
                                            <input type="radio" name="payment-method" id="COD" class="custom-control-input" value="cod" v-model="paymentOptions">
                                ...
                                <div class="py-3">
                                    ...
                                    <div class="tch-order-card product_chose_item" v-for="(order,index) in orders" :key="index" style="display:inherit;">
                                        <div v-for="product in order.product_item" :key="product.name" class="product_chose_item">
                                            <div class="tch-order-card__left " style="display: flex">
                                                <Card_Fix_Order style="z-index : 999" :count="order.count" :index="index" :topping_1="order.topping_items[0].count" :topping_2="order.topping_items[1].count" :topping_3="order.topping_items[2].count" :topping_4="order.topping_items[3].count" :topping_5="order.topping_items[4].count" :size="order.size" :currentID="product.id" :dialog="false" :id="product.id" :image_url="product.image_url" :name="product.name" :description="product.description" :price="product.price" :isInProductListing=0> </Card_Fix_Order>
                                    ...
                                    <div class="tch-checkout-box tch-checkout-box--list-total tch-checkout-border " style="padding: 14px 0 30px ">
                                        ...
                                        <div class="tch-order-card product_chose_item">
                                            ...
                                            <div class="tch-order-card__right">
                                                <p class="tch-order-card__price mb-0">15000đ</p>
                                            </div>
                                        </div>
                                        <hr>
                                    </div>
...
export default {
    name: "checkOut",
    components: {
        Card_Fix_Order: () => import("@/components/userComponents/Card_Fix_Order"),
    },
    data() {
        return {
            paymentOptions: "cod",
                ...
                if (this.paymentOptions == 'cod') { // neu chon thanh toan tien mat
                    ...
                    axios 
                        ...
                        .then((response) => {
                            console.log("RES:\n")
                            console.log("respon1: ", response);
                            console.log("this total price: ", Number(this.total_price) * 1000)
                            console.log("END RES\n")
                            this.order_id = response.data.order_id
                            console.log("orrderid: ", this.order_id)
                            axios //
                                ...
                                .then((response2) => {
                                    ...
                                    axios
                                        .post("http://127.0.0.1:8000/api/admin/order/paidOrder", { // update trang thai don hang thanh da thanh toan
                                            order_id: this.order_id
                                        })
                                        .then((response) => {
