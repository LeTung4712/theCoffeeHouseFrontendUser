                                                            ...
                                                            <div class="product-search">
                                                                ...
                                                                <div class="product-search-right">
                                                                    ...
                                                                    <div style="display: flex!important;justify-content: space-between;align-items: center">
                                                                        ...
                                                                        <Card_User_Order style="z-index : 999" :currentID="product_search.id" :dialog="dialog" :id="product_search.id" :image_url="product_search.image_url" :name="product_search.name" :description="product_search.description" :price="product_search.price" :isInProductListing=1></Card_User_Order>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                    ...
                    <div>
                        ...
                        <div class="row">
                            ...
                            separator(product.price)
                                            ...
                                            <Card_User_Order style="z-index : 999" :currentID="currentID" :dialog="dialog" :id="product.id" :image_url="product.image_url" :name="product.name" :description="product.description" :price="product.price" :isInProductListing=1>
                                            </Card_User_Order>
